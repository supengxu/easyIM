...
public final class WSMessageResProtoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return WSMessageResProtoOuterClass.internal_static_protocol_WSMessageResProto_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return WSMessageResProtoOuterClass.internal_static_protocol_WSMessageResProto_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              WSMessageResProtoOuterClass.WSMessageResProto.class, WSMessageResProtoOuterClass.WSMessageResProto.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof WSMessageResProtoOuterClass.WSMessageResProto)) {
        return super.equals(obj);
      }
      WSMessageResProtoOuterClass.WSMessageResProto other = (WSMessageResProtoOuterClass.WSMessageResProto) obj;
    ...
    public static WSMessageResProtoOuterClass.WSMessageResProto parseFrom(
    ...
    public static WSMessageResProtoOuterClass.WSMessageResProto parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static WSMessageResProtoOuterClass.WSMessageResProto parseFrom(
    ...
    public static WSMessageResProtoOuterClass.WSMessageResProto parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static WSMessageResProtoOuterClass.WSMessageResProto parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static WSMessageResProtoOuterClass.WSMessageResProto parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(WSMessageResProtoOuterClass.WSMessageResProto prototype) {
    ...
    public static final class Builder extends
        ...
        WSMessageResProtoOuterClass.WSMessageResProtoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return WSMessageResProtoOuterClass.internal_static_protocol_WSMessageResProto_descriptor;
      }
      ...
      // Construct using top.xxpblog.easyChat.common.protobuf.WSMessageResProtoOuterClass.WSMessageResProto.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public WSMessageResProtoOuterClass.WSMessageResProto getDefaultInstanceForType() {
        return WSMessageResProtoOuterClass.WSMessageResProto.getDefaultInstance();
      }

      @java.lang.Override
      public WSMessageResProtoOuterClass.WSMessageResProto build() {
        WSMessageResProtoOuterClass.WSMessageResProto result = buildPartial();
      ...
      @java.lang.Override
      public WSMessageResProtoOuterClass.WSMessageResProto buildPartial() {
        WSMessageResProtoOuterClass.WSMessageResProto result = new WSMessageResProtoOuterClass.WSMessageResProto(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof WSMessageResProtoOuterClass.WSMessageResProto) {
          return mergeFrom((WSMessageResProtoOuterClass.WSMessageResProto)other);
        } else {
      ...
      public Builder mergeFrom(WSMessageResProtoOuterClass.WSMessageResProto other) {
        if (other == WSMessageResProtoOuterClass.WSMessageResProto.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        WSMessageResProtoOuterClass.WSMessageResProto parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (WSMessageResProtoOuterClass.WSMessageResProto) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final WSMessageResProtoOuterClass.WSMessageResProto DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new WSMessageResProtoOuterClass.WSMessageResProto();
    }

    public static WSMessageResProtoOuterClass.WSMessageResProto getDefaultInstance() {
